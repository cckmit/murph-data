...
) ENGINE=InnoDB AUTO_INCREMENT=800095348450070529 DEFAULT CHARSET=utf8mb4 COMMENT='询价单表'
;


-- impala
create table tct_ods.qshop_qd_buy_offer_7 (
